...
*******************************************************************************/
#ifndef BACKEND_ELYZOR_PATTERNS_SINGLE_OP_PATTERN_HPP
#define BACKEND_ELYZOR_PATTERNS_SINGLE_OP_PATTERN_HPP

#include <memory>
#include <utility>

#include "graph/backend/elyzor/patterns/fusions.hpp"
