...
*******************************************************************************/
#ifndef BACKEND_ELYZOR_PATTERNS_FUSIONS_HPP
#define BACKEND_ELYZOR_PATTERNS_FUSIONS_HPP

#include <vector>

#include "graph/backend/elyzor/patterns/transformation_pattern.hpp"
#include "graph/backend/elyzor/target_machine.hpp"
...
inline const std::vector<graph::op_kind_t> get_no_constraint_ops() {
    auto supported_kinds = utils::get_supported_op_kinds();
