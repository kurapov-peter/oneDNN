...
class elyzor_backend_t : public backend_t {
    friend class elyzor_partition_impl_t;

public:
    static elyzor_backend_t &get_singleton() {
        static elyzor_backend_t ins(
...
private:
    elyzor_backend_t(const std::string &backend_name, float priority)
